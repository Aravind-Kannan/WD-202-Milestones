...
# * Validators are active when creating `User`
...
# `task_manger` app specific routing:
# * On successful login, 'landing page' for every user
LOGIN_REDIRECT_URL = "/tasks"
# ! If `AnonymousUser` tries to login, throw him to 'login page' (authenticate) before allowing to access other routes
